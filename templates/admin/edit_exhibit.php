...
require_once dirname(__DIR__, 2) . '/includes/db.php'; include dirname(__DIR__, 2) . '/templates/components/header.php'; include dirname(__DIR__, 2) . '/templates/components/admin_sidebar.php';
