    ...
    <div class="container">
        ...
        <div class="info-grid">
            ...
            <div class="info-box">
                ...
                <p><strong>Email:</strong> josecarlosblagatuz@gmail.com / labotourism08@yahoo.com</p>
                <p><strong>Phone:</strong> (054) 885-1074 / 0928-661-2138</p>
            </div>
        </div>
        ...
        <div class="content-section" style="margin-top: 60px;">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="https://maps.app.goo.gl/mz9quW5tLAth5yZ46" target="_blank" style="display: inline-block; background: var(--gold); color: #333; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; cursor: pointer; transition: background 0.3s;">
                    📍 Show the Way
                </a>
            </div>
        </div>
